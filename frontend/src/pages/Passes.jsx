        ...
        <div className="w-full sm:w-[360px] bg-slate-950 rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[92vh] sm:max-h-[90vh]">
          ...
          <div className="overflow-y-auto flex-1 px-4 pb-8">
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
              {/* Airline header – use pass colors if available */}
              <div className="px-6 py-5"
                style={pass.color_background
...
function PassGridCard({ pass, onClick }) {
  ...
  // If pass has its own background color, use it as the card color
  // Otherwise fall back to white ticket style
  const hasColor = !!bg
  ...
  return (
    <button onClick={onClick}
      ...
      {/* Ticket background – pass color or white */}
      <div style={hasColor ? { backgroundColor: bg } : {}} className={hasColor ? "" : "bg-white"}>
        {/* Top stripe: subtle gradient if colored, colored stripe if white */}
        {hasColor
        ...
        <div className="relative flex items-center my-0">
          ...
          <div className="flex-1 mx-3" style={{ borderTop: `1px dashed ${fg ? fg + "44" : (hasColor ? "rgba(255,255,255,0.2)" : "#e2e8f0")}` }} />
